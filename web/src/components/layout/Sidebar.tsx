...
import { Home, Calendar, MessageSquare, Users, Briefcase, Settings, LogOut, TrendingUp, Database, CalendarX } from "lucide-react";
...
const navItems = [
    ...
    { href: "/dashboard/reminders", label: "Lembretes", icon: MessageSquare },
